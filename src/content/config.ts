...
const blog = defineCollection({
	...
	schema: ({ image }) =>
		z.object({
			...
			contentPillar: z
				.enum(['dot-by-dot', 'connecting-the-dots', 'the-big-picture', 'behind-the-dots'])
				.default('dot-by-dot'),
			department: z
				.enum(['engineering', 'marketing', 'sales', 'hr', 'finance', 'operations', 'legal', 'customer-support', 'design'])
				.optional(),
