...
7. Writes outreach emails — 30 minutes
...
1. AI surfaces 50 ICP-matched companies with intent signals — automatic
2. AI enriches contacts with email, phone, role, and context — automatic
3. Rep reviews and selects the best 20 prospects — 15 minutes
4. AI generates personalized outreach drafts based on prospect context — 5 minutes
5. Rep reviews, edits, and sends — 20 minutes
...
For tips on writing effective outreach after you have found your prospects, see our guide on [AI sales emails](/blog/ai-sales-emails).
...
For more on prioritizing the prospects AI finds, see our guide on [AI lead scoring](/blog/ai-lead-scoring). And for preparing before those first conversations, check out [AI for sales call prep](/blog/ai-for-sales-call-prep).
