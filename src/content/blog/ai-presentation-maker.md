...
description: 'AI presentation makers can build a slide deck in minutes. The problem is they all look the same. Here is how to use AI slides tools and actually get results worth presenting.'
pubDate: '2026-03-15'
...
If you want to get better at writing prompts generally, the same principles from [using an AI writing assistant](/blog/ai-writing-assistant-keep-your-voice) apply here: give the AI context, constraints, and examples of what good looks like.
