...
faqs:
  - question: "What is the best AI email marketing tool for small businesses?"
    answer: "Mailchimp and Brevo are the strongest choices for small businesses. Mailchimp offers a free tier (500 contacts, 1,000 sends/month) with Intuit Assist AI for copy suggestions and send-time optimization. Brevo's free plan covers 300 emails/day with no contact limit. Both have paid plans under $25/month when you need more capacity."
  - question: "Can AI write my email marketing campaigns?"
    answer: "Yes — every major platform now includes an AI content generator. Mailchimp's Intuit Assist, HubSpot's AI email writer, and Beehiiv's Magic AI can draft subject lines, body copy, and CTAs. Expect to spend 5-10 minutes editing per email rather than 30-45. The AI produces a workable first draft; you add brand voice and specific context."
  - question: "What is the difference between Klaviyo and Mailchimp AI features?"
    answer: "Klaviyo leads in predictive AI: it forecasts purchase probability, churn risk, and expected order value per contact, then triggers automated flows from those predictions. Mailchimp focuses on content AI — copy suggestions and send-time optimization. Klaviyo suits e-commerce teams with transactional data; Mailchimp suits smaller teams wanting straightforward content assistance."
  - question: "Is HubSpot AI email marketing worth the price?"
    answer: "HubSpot's AI email features are strong, but they require Marketing Hub Pro at $800/month — a large jump from competitors. They make sense only if you're already in the HubSpot CRM ecosystem and need the full integration. Otherwise, Klaviyo or ActiveCampaign deliver comparable AI capabilities at a fraction of the cost."
  - question: "Which AI email marketing platform has the best free plan?"
    answer: "Mailchimp offers the most useful free tier: 500 contacts, 1,000 sends/month, and Intuit Assist AI features included. Brevo's free plan allows 300 emails/day with no contact limit. Beehiiv's free tier supports up to 2,500 subscribers with Magic AI writing. HubSpot has a free tier but restricts AI features to paid plans."
---
