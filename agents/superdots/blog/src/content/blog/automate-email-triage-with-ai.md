...
1. **Needs my reply** — someone asked you a direct question
2. **FYI only** — you're CC'd or it's informational
3. **Meeting-related** — invites, reschedules, agendas
4. **Automated notifications** — CI/CD alerts, tool notifications, shipping updates
5. **External/sales** — cold outreach, newsletters
6. **Delegatable** — requests that someone on your team should handle instead
...
- **[Gmail](https://workspace.google.com)**: Settings > Inbox > Categories. Enable the AI-powered "Priority" view. Gmail's AI already sorts by importance, but most users never activate it. Also enable "Nudges" — Gmail will remind you about emails you received but haven't replied to, and emails you sent but haven't gotten a response to.
- **[Microsoft Outlook](https://www.microsoft.com/en-us/microsoft-365/outlook)**: Use Copilot's email summary and categorization features. Copilot can summarize long threads, suggest replies, and highlight action items. If your organization has a Microsoft 365 subscription, this is already included.

For more advanced automation, tools like SaneBox and Superhuman layer AI on top of your existing email client. You can also connect email workflows to automation platforms like [Zapier](https://zapier.com) to trigger actions across your other tools. SaneBox automatically moves unimportant emails out of your inbox into a separate folder you review once a day. Superhuman uses AI to surface the messages that matter and helps you blow through the rest.
...
- **Status requests**: Pull the latest from your [project management tool](/blog/ai-project-management-features-guide/) and draft a concise update
...
Meeting notes? AI handles that too — check out [AI meeting notes and action items](/blog/ai-meeting-notes-summaries-action-items/). Report writing? [AI writing assistants](/blog/ai-writing-assistant-keep-your-voice/) can draft those. Data analysis? Even [non-technical teams](/blog/ai-data-analysis-for-non-technical-teams/) are using AI for that now.
